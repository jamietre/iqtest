...
*/
(function(b){var d=b.impl.utility,c={group:'<pre><h1>Starting test group "<iq-name></iq-name>": <iq-groupresult></iq-groupresult></h1><div><div></div></div></pre>',testStart:'<h2>Starting test "<iq-name></iq-name>": <iq-testresult></iq-testresult></h2><div></div>',testEnd:"<h3><iq-count></iq-count> test items finished.</h3>",itemStart:'<span style="color: blue;font-style: italic;">Running test #<iq-count></iq-count>: <iq-assertion></iq-assertion> "<iq-desc></iq-desc>"....</span><br/>',itemEnd:"<span><iq-fulltext></iq-fulltext></span><br/>",resultSuccess:'<span style="color:green"><iq-resulttext></iq-resulttext></span>',resultFail:'<span style="color:red"><iq-resulttext></iq-resulttext></span>',log:'<span style="color:purple"><iq-message></iq-message></span><br/>'};

...
}function n(v,u){var t=0;f.each(v,function(x,w){if(t===u){return x;}});}f.expectOpts(2);
...
}}}else{s=e(l,i,q);}}return s||{passed:!r,err:d(q,r)};}function g(j,i,k){return e(j,i,k,true);
}return{contentsEqual:b,propertiesEqual:e,valuePropertiesEqual:g};});}(typeof define==="function"?define:function(a){if(typeof module!=="undefined"){module.exports=a(require("./iqtest"));

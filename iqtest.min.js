...
F.reject();});return E;},defer:function(u,G){var D=this,E=B.defer(),F=G||D.timeout;
D.promise=F?C(E,F*1000):E;if(u){E.then(u);}return E;},backpromise:function(G,u,J){var E=B.defer(),H=this,I=J||H.timeout,D=function(){var L;
